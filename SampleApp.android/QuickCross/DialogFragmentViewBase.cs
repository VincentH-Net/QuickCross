...
{
    public class DialogFragmentViewBase : DialogFragment
    {
    ...
    public class DialogFragmentViewBase<ViewModelType> : DialogFragmentViewBase, ViewDataBindings.IViewExtensionPoints where ViewModelType : ViewModelBase
    {
        ...
        /// <summary>
        /// If you override the OnCreateDialog method in a derived view class, call this Initialize() method there to initialize the viewmodel.
        /// </summary>
        /// <param name="viewModel"></param>
        protected void Initialize(ViewModelType viewModel)
        {
            ViewModel = viewModel;
        }

        /// <summary>
        /// If you override the OnCreateView method in a derived view class, call this Initialize() method there to create the data bindings and update the view with the current view model values.
        /// </summary>
