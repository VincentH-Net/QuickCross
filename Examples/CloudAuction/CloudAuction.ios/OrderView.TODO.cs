/* TODO: To complete adding the Order storyboard view, follow these steps:
 *
 ...
 * 3 Set the Class name and the Storyboard ID for the controller to OrderView 
 *   (it is recommended to also check 'Use Storyboard ID' so you will use the same name for the Restoration ID).
 * 4 Save and switch back from XCode to Xamarin Studio to have the OrderView.cs and OrderView.designer.cs files generated.
 * 5 Copy and paste the complete code below over the content in the generated OrderView.cs file.
 * 6 Review the generated NavigateToOrderView method in your CloudAuctionNavigator class to see
 *   if it uses the navigation method that you intend (segue / push / ...).
 * 7 Delete this OrderView.TODO.cs file.
