...
{
    /// <summary>
    /// Base class for UITabBarController views that have no viewmodel. 
    ...
    /// </summary>
    public abstract class TabBarViewBase : UITabBarController
    {
    ...
    /// <summary>
    /// Base class for UITabBarController views that have a viewmodel. 
    /// This class adds a viewmodel and bindings.
    /// </summary>
    /// <typeparam name="ViewModelType">The viewmodel type</typeparam>
    public class TabBarViewBase<ViewModelType> : TabBarViewBase, ViewDataBindings.IViewExtensionPoints where ViewModelType : ViewModelBase
    {
        public TabBarViewBase() { }
        public TabBarViewBase(string nibName, NSBundle bundle) : base(nibName, bundle) { }
        public TabBarViewBase(IntPtr handle) : base(handle) { }
